...
from seya.layers.conv_rnn import ConvGRU, HalfConvGRU


class TestHalfConvGRU(unittest.TestCase):
    ...
    def test_basic(self):
        ...
        input_flat = ndim ** 2
        layer = HalfConvGRU(filter_dim=(1, filter_dim, filter_dim), reshape_dim=(1, ndim, ndim),
