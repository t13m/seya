...
class HalfConvGRU(Recurrent):
    def __init__(self, filter_dim, reshape_dim, batch_size, subsample=(1, 1),
        ...
        super(HalfConvGRU, self).__init__(**kwargs)
    ...
    def build(self):
        ...
        self.params = [self.U_h] + self.conv_z.params + self.conv_r.params + \
    ...
    def get_config(self):
        ...
        base_config = super(HalfConvGRU, self).get_config()
